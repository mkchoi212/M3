...
/*Default Colors*/
#define RJTitleLabelBackgroundColor [UIColor blackColor]
#define RJComfirmButtonColor [UIColor blackColor]
...
- (void)_labelSetupWithTitle:(NSString*) title andText:(NSString*) text
{
    ...
    _titleLabel.font = [UIFont fontWithName:@"TimesNewRomanPSMT" size:25.0f];
    ...
    if (self.contentType == RJBlurAlertViewContentTypeText) {
        ...
        _textLabel.font = [UIFont fontWithName:@"TimesNewRomanPS-ItalicMT" size:RJAlertViewDefaultTextFontSize];
...
- (void)_buttonSetupWithCancelButton:(BOOL) hasCancelButton
{
    ...
    if (hasCancelButton) {
        ...
        _cancelButton.titleLabel.font = [UIFont fontWithName:@"TimesNewRomanPSMT" size:18.0f];
    ...
    //ok button end setup
    [_okButton setTitle:@"YES" forState:UIControlStateNormal];
    _okButton.titleLabel.font = [UIFont fontWithName:@"TimesNewRomanPSMT" size:18.0f];
...
{
    UIFont *font = [UIFont fontWithName:@"TimesNewRomanPSMT" size:RJAlertViewDefaultTextFontSize];
