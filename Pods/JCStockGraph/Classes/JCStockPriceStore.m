...
- (BOOL)getDataForTicker:(NSString *)ticker withProgress:(void (^)(double progress))progBlock completion:(void (^)(NSArray *points))comp
{
    ...
    [operation setCompletionBlockWithSuccess:^(AFHTTPRequestOperation *operation, id responseObject) {
        ...
        notification.notificationLabelBackgroundColor = [UIColor colorWithRed:255.0/255.0 green:204.0/255.0 blue:0 alpha:1.0];
        notification.notificationLabelTextColor = [UIColor whiteColor];
        [notification displayNotificationWithMessage:@"Error getting stock data" forDuration:3];
