                  ...
                  key:(NSString *)key;
{
    ...
    banner.completedColor = [UIColor colorWithRed:48.0/255.0 green:152.0/255.0 blue:255.0/255.0 alpha:1.0];
    banner.key = key;
    banner.message = message;
    banner.completedMessage = completionMessage;
    banner.completedDelay = 2.5;
    banner.messageFont = [UIFont systemFontOfSize:16];
