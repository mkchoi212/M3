...
class BusinessCell: UITableViewCell {
    ...
    func setBusiness(business: Business, forIndex index: Int) {
        ...
        numberOfReviewsLabel.text = "\(business.numberOfReviews) Reviews".uppercaseString
        addressLabel.text = business.address.uppercaseString
        categoryLabel.text = business.categories.uppercaseString
    }
